    ...
    <body id="page-top">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4 ">
                            <div class="card-header d-sm-flex align-items-center justify-content-between mb-4">
                                <h6 class="m-0 font-weight-bold text-primary">Comment in issue ${issue.name}</h6>
                                <h1>${roleProject}</h1>
                                <c:if test="${session.getRole_project() == 'TL'}">
                                    <a href="issue" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                        <i class="fa-solid fa-chevron-left"></i> Back to list issue
                                    </a>
                                </c:if>
                            </div>
                            <div class="card-body">
        ...
        <script>
            ...
            function saveChanges() {
                ...
                var issue_id_element = document.getElementsByName("issue_id")[0]; // Lấy phần tử input hidden cho issue_id
                if (id_comment_element && issue_id_element) {
                    var id_comment = id_comment_element.value;
                    var issue_id = issue_id_element.value;
                    ...
                    // Chuyển hướng tới URL edit_comment với tham số id_comment, issue_id, và giá trị đã chỉnh sửa
                    window.location.href = "edit_comment_issue?idcomment=" + id_comment + "&issue_id=" + issue_id + "&comment=" + editedComment;
                } else {
                    console.error("Element with name 'id_comment' or 'issue_id' not found or has no value.");
                }
            }
