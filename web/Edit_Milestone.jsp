                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <form action="edit_milestone2" method="POST">
                                    <table class="table table-bordered" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <th><input type="text" id="id_milestone" name="id_milestone" class="form-control" placeholder="${milestone.id_milestone}" value="${milestone.id_milestone}" readonly ></th>
                                            <th><input type="text" id="milestoneName" name="milestoneName" class="form-control"  placeholder="${milestone.name_milestone}" value="${milestone.name_milestone}"></th>
                                            <th><input type="date" id="startDate" name="startDate" class="form-control"  value="${milestone.start_date}"></th>
                                            <th><input type="date" id="endDate" name="endDate" class="form-control"  value="${milestone.end_date}"></th>
                                            <th><input type="text" id="id_Project" name="id_Project" class="form-control" readonly="" placeholder="${milestone.id_Project}" value="${milestone.id_Project}"></th>
                                            </tr>
                                            </tbody>
                                    </table>
                                    <div class="text-center"> <!-- Thêm class text-center để căn giữa -->
                                        <button type="submit" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                            <i class="fa-solid fa-plus"></i> Save Change
                                        </button>
                                    </div>
                                    </form>
                                </div>
