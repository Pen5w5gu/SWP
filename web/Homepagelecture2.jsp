    ...
    <body>
        ...
        <style>
            ...
            .content_menu a {
                ...
                color: #333;
                border-radius: 10px;
                /* Increased border radius to create a square shape */
                transition: background-color 0.3s ease;
                background-color: #ffffff;
                box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1);
            }
            ...
            .content_menu a:hover {
                ...
                .content_class {
                    ...
                    gap: 20px;
                    /* Adjust the gap between squares based on your design */
                }
                        ...
                        <div class="dropdown-content additional-info">
                            ...
                            <div class="header_classrom">
                                <div class="icon_classroom">
                                    <img
                                        src="https://e7.pngegg.com/pngimages/78/883/png-clipart-computer-icons-google-classroom-keyword-research-technical-application-text-black.png">
                                </div><!-- comment -->
                                <a href="#">My Clss</a>
                            ...
                            <div class="header_project">
                                <div class="icon_project">
                                    <img
                                        src="https://w7.pngwing.com/pngs/599/165/png-transparent-project-management-task-computer-icons-others-text-logo-project-management.png">
                                </div>
                                <a href="#">My Project</a>
                            </div>
                            <div class="header_project">
                    ...
                    <ol class="row">
                        <c:choose>
                            <c:when test="${not empty classes}">
                                ...
                                <c:forEach var="myclass" items="${classes}">
                                    <li class="classess col-md-3">
                                        <div class="headLi">
                                            <div>Class ${myclass.class_name}</div>
                                            <div>${session.getUsername()}</div>
                                        </div>
                                        <div class="contentLi">

                                        </div>
                                        <div style="display: flex" class="footerLi">
                                            <form id="form_${myclass.class_name}" action="showproject" method="GET"
                                                  onsubmit="return submitForm('${myclass.class_name}')">
                                                <a href="#"
                                                   onclick="document.getElementById('form_${myclass.class_name}').submit();"><i class="fa-solid fa-list-check"></i></a>
                                            ...
                                            <form id="form_${myclass.class_name}" action="showproject" method="GET"
                                                  onsubmit="return submitForm('${myclass.class_name}')">
                                                <a href="#"
                                                   onclick="document.getElementById('form_${myclass.class_name}').submit();"><i class="fa-regular fa-folder"></i></a>
                                                <input type="hidden" name="class_name"
                                                       value="${myclass.class_name}">
                                            </form>
