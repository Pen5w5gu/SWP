<%-- 
    Document   : Homepagelecture
    Created on : Feb 5, 2024, 10:17:18 PM
    Author     : quann
--%>
                                ...
                                <c:when test="${not empty classes}">
                                    <c:forEach var="myclass" items="${classes}">
                                        <form id="form_${myclass.class_name}" action="showproject" method="GET"
                                            ...
                                            <a href="#" class="collapse-item" onclick="document.getElementById('form_${myclass.class_name}').submit();">Class
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <form
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control bg-light border-0 small" placeholder="chưa đi vào hoạt động =))"
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                   data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="mr-2 d-none d-lg-inline text-gray-600 small">Xin chào, ${session.getUsername()}</span>
                                            ...
                                            <div class="card border-left-info shadow h-100 py-2">
                                                <div class="card-body">
                                                    <div class="row no-gutters align-items-center">
                                                        <div class="col mr-2">
                                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Class ${myclass.class_name}</div>
                                                        ...
                                                        <div class="col-12 text-right d-flex justify-content-end align-items-center">
                                                            <form id="form_${myclass.class_name}" action="showproject" method="GET"
                                                                  onsubmit="return submitForm('${myclass.class_name}')" class="mr-2">
                                                                <a href="#" onclick="document.getElementById('form_${myclass.class_name}').submit();">
                                                            ...
                                                            <form id="form_${myclass.class_name}_folder" action="showproject" method="GET"
                                                                  onsubmit="return submitForm('${myclass.class_name}')">
                                                                <a href="#" onclick="document.getElementById('form_${myclass.class_name}_folder').submit();">
