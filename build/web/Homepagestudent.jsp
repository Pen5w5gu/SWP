<%-- 
    ...
    Created on : Feb 6, 2024, 10:04:32 PM
    Author     : quann
--%>
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Nav Item - Task -->
                <li class="nav-item">
                    <a class="nav-link" href="Taskpage.jsp">
                                                        ...
                                                        <div class="row no-gutters align-items-center">
                                                            ...
                                                            <div class="col mr-2">
                                                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                                    Project ID: ${project.id_Project}</div>
                                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                                    <a style="text-decoration: none;" href="#" onclick="document.getElementById('form_${project.project_name}').submit();">${project.project_name}</a>
                                                                </div>
                                                            </div>
                                                            <div class="col-auto">
