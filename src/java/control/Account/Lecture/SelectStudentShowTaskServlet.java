 ...
 * @author acer
 */
public class SelectStudentShowTaskServlet extends HttpServlet {
...
//
        ...
        String user_name = adao.getUsernameById(id_account);
        
        TaskTypeDAO ttdao = new TaskTypeDAO();

        TaskDAO tdao = new TaskDAO();
        List<Task> tasks = tdao.getTaskByLecture(id_account, class_name);
