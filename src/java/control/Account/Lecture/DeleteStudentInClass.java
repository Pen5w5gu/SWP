 ...
 * @author Nhin Nhin
 */
@WebServlet(name = "DeleteStudentInClass", urlPatterns = {"/deleteStudent"})
public class DeleteStudentInClass extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String IdJoin = request.getParameter("IdJoin");
        ...
        try {
            update.updateAllowAccess(user.getId_account(), project_id);
        } catch (Exception e) {
        }

        response.sendRedirect("showstudentinclass?classname=" + request.getParameter("classname"));
    }
